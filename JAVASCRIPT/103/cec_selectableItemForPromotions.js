vlocity.cardframework.registerModule.controller('labsxdVlcPromotionsController', ['$scope', '$rootScope', 'bpService', function($scope, $rootScope, bpService) {
    ...
    // Init Promotions
    console.log('CEC_DEBUG | cec_selectableItemForPromotions - Init Promotions');
    ...
    $scope.getFamilyIcon = function (scp, control, orderItem) {
        ...
        if (familyIconsList) {
            familyIconsList.forEach(function(element, index){
                ...
                }  else if (orderItem.PricebookEntry.Product2.Family == "Internet Fixa") {
                    result = "/resource/cec_identidade/images-upload/comercial/icon-internet.png";
                }
            });
        }
